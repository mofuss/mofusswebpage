...
<!--        <a href="--><?php //echo base_url();?><!--/analysistype" class="waves-effect waves-light btn green">Web-based Mofuss</a>-->
<!--        <a href="--><?php //echo base_url();?><!--/countrydefault" class="waves-effect waves-light btn green">Country Default</a>-->
        <p>
            Tier levels in MoFuSS are inspired by the IPCC classification. Progressing from Tier 1 to Tier 3 generally represents a reduction in the uncertainty of NRB estimates.
        </p>
