<div class="modal modal-fixed-footer" id="charts-modal" style="width: 80%;">
    <div class="modal-content">
        <div class="row">
            <div class="col s12">
                <h5 class="green-text">Test Charts</h5>
            </div>
        </div>
...
<!--                                </p>-->
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="sample-chart-wrapper"><canvas id="line-chart" height="80"></canvas></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="sample-chart-wrapper"><canvas id="bar-chart" height="80"></canvas></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="sample-chart-wrapper"><canvas id="radar-chart" height="80"></canvas></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                ...
                                <div class="row">
                                    <div class="col s12">
                                        ...
                                        <div class="sample-chart-wrapper"><canvas id="polar-chart" height="80"></canvas></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col s12">
                                        ...
                                        <div class="row">
                                            <div class="col s12 m6 l6">
                                                <div class="sample-chart-wrapper"><canvas id="pie-chart" height="150"></canvas></div>
                                                <p class="header center">Pie Charts</p>
                                            </div>
                                            <div class="col s12 m6 l6">
                                                <div class="sample-chart-wrapper"><canvas id="doughnut-chart" height="150"></canvas></div>
