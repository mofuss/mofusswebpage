...
<div class="container-medium" style="margin: 0;">
...
<!--        <div class="col s12 m10 l10 " >-->
        <div style=" width: 80%; margin: 0 auto;">
            <div id="highlight-table" class="scrollspy">
                    <div class="row">
                        <div class="col s12">
                        </div>
                        <div class="col s12">
...
<!--                                </thead>-->
                                ...
                                <tr>
                                    ...
                                    <td class="text-size-14"><b>Tier 1</b> employs global datasets freely available. Input parameters, such as biomass growth functions for example, are derived from global datasets, resulting in wide variations that are propagated within MoFuSS as uncertainty. </td>
                                </tr>
                                <tr>
                                    <td>
                                        <i class="tiny material-icons amber-text">brightness_1</i>
                                    </td>
                                    <td class="text-size-14"><b>Tier 2</b> employs country datasets mostly available to the general public. Input parameters are based in available information for the country. </td>
                                </tr>
                                <tr>
                                    <td>
                                        <i class="tiny material-icons green-text text-darken-3">brightness_1</i>
                                    </td>
                                    <td class="text-size-14"><b>Tier 3</b> employs country or regional datasets produced specifically for MoFuSS, and sometimes calibrated with ground data. In certain cases, some sort of validation of parameters and /or results are available. </td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
...
<!--        <p class="text-size-14">-->
            <!--            Tier 1 employs global datasets freely available. Input parameters, such as biomass growth functions for example, are derived from global datasets, resulting in wide variations that are propagated within MoFuSS as uncertainty.-->

<!--        </p>-->
        <div style=" width: 80%; margin: 0 auto;">
        <p class="text-size-14" style=" color:#333333">
    ...
    <div class="row">
        <div class="col s12 m6 l4 card-width">
            <a href="<?php echo base_url();?>/dashdefault/global">
                <div class="card cardmenu1 border-radius-6" style="height: 250px">
                    <div class="card-content center-align">
                        <img class="map-menu" src="<?php echo base_url();?>/public/app-assets/images/mofuss/globes/globe1.png">
<!--                        <h5 class="m-0"><b>Global Analysis 1</b></h5>-->
                        <h5 class="m-0"><b>Fraction of NonRenewable Biomass</b></h5>
<!--                        <i class="tiny material-icons red-text text-darken-4">brightness_1</i>-->
<!--                        <i class="grey-text text-darken-2">Tier 1</i>-->
                    </div>
                </div>
        ...
        <div class="col s12 m6 l4 card-width">
            <a href="<?php echo base_url();?>/dashdefault/globalmap">
                <div class="card cardmenu1 border-radius-6" style="height: 250px">
                    <div class="card-content center-align">
                        <img class="map-menu" src="<?php echo base_url();?>/public/app-assets/images/mofuss/globes/globemap.png">
                        <h5 class="m-0"><b>Global Analysis 2</b></h5>
<!--                        <i class="tiny material-icons red-text text-darken-4">brightness_1</i>-->
<!--                        <i class="grey-text text-darken-2">Tier 1</i>-->
                    </div>
                </div>
        ...
        <div class="col s12 m6 l4 card-width">
            <a href="<?php echo base_url();?>/dashdefault/globalv2">
                <div class="card cardmenu1 border-radius-6" style="height: 250px">
                    <div class="card-content center-align">
<!--                        <img class="map-menu" src="--><?php //echo base_url();?><!--/public/app-assets/images/mofuss/globes/globe1.png">-->
                        <img class="map-menu" src="<?php echo base_url();?>/public/app-assets/images/mofuss/globes/globev2.png">
                        <h5 class="m-0"><b>Global Analysis 3</b></h5>
<!--                        <i class="tiny material-icons red-text text-darken-4">brightness_1</i>-->
<!--                        <i class="grey-text text-darken-2">Tier 1</i>-->
                    </div>
                </div>
...
<!--        <p class="text-size-14">-->
<!--            Tier 2 employs country datasets mostly available to the general public. Input parameters are based in available information for the country.-->
<!--        </p>-->
    </div>
    ...
    <div class="row">
        <div class="col s12 m6 l3 card-width">
            ...
            <div class="card cardmenu2 border-radius-6" >
                <div class="card-content center-align">
...
<!--        <p class="text-size-14">-->
<!--            Tier 3 employs country or regional datasets produced specifically for MoFuSS, and sometimes calibrated with ground data. In certain cases, some sort of validation of parameters and /or results are available.-->
<!--        </p>-->
    ...
    <div class="row">
        <div class="col s12 m6 l6 card-width">
            <a href="<?php echo base_url();?>/dashdefault/country/MC">
                <div class="card cardmenu3 border-radius-6" >
                    <div class="card-content center-align">
                        <img class="map-menu" src="<?php echo base_url();?>/public/app-assets/images/mofuss/mapas-svg/lime/michoacan.svg">
                        <h5 class="m-0"><b>Michoacán - Mexico</b></h5>
                        <!--                    <p>Info</p>-->
<!--                        <i class="tiny material-icons red-text text-darken-4">brightness_1</i>-->
<!--                        <i class="grey-text text-darken-2">Tier 1</i>-->
        ...
        <div class="col s12 m6 l6 card-width">
<!--            <a href="#">-->
                <a class="tooltipped" href="#info" data-position="top" data-tooltip="In progress. Not yet available.">

                <div class="card cardmenu3 border-radius-6" >
                    <div class="card-content center-align">
                        <img class="map-menu" src="<?php echo base_url();?>/public/app-assets/images/mofuss/mapas-svg/lime/peru.svg">
                        <h5 class="m-0"><b>Koppal - India</b></h5>
                        <!--                    <p>Info</p>-->
<!--                        <i class="tiny material-icons red-text text-darken-4">brightness_1</i>-->
<!--                        <i class="grey-text text-darken-2">Tier 1</i>-->
