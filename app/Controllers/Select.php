...
//        var_dump($data);
        ...
        return   view('layouts/header_dashboard').view('layouts/aside_dashboard',$data).view('main/body_dashboard',$estatus).view('layouts/hagg').view('layouts/crop_locs').view('layouts/friction').view('layouts/cost_distance').view('layouts/charts').view('layouts/tables').view('layouts/select').view('layouts/loading').view('layouts/footer_dashboard_select',$data);
...
//        $rcommand="/anaconda/bin/Rscript masktreecover.r";
...
//        $rcommand="/anaconda/bin/Rscript masklossyear.r";
        $output = shell_exec($rcommand);
//        echo "<pre>$output</pre>";
        chdir($cwd);
...
//        $rcommand="/anaconda/bin/Rscript maskgain.r";
        $output = shell_exec($rcommand);
//        echo "<pre>$output</pre>";
        chdir($cwd);
    }
