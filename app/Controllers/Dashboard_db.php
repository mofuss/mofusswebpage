...
//var_dump($data);
        ...
        if (file_exists($absolutepath . '/public/maps/countries/'.$country.'.geojson')) {
...
//        return   view('layouts/header_dashboard').view('layouts/aside_dashboard',$data).view('main/body_dashboard').view('layouts/hagg').view('layouts/crop_locs').view('layouts/friction').view('layouts/cost_distance').view('layouts/select').view('layouts/footer_dashboard',$data);
            return   view('layouts/header_dashboard').view('layouts/aside_dashboard',$data).view('main/body_dashboard',$estatus).view('layouts/hagg',$data).view('layouts/crop_locs').view('layouts/friction').view('layouts/cost_distance').view('layouts/charts').view('layouts/tables').view('layouts/select').view('layouts/footer_dashboard_select',$data);

        } else {
//            echo "El fichero no existe";
            return redirect()->to(base_url().'/webmofuss');
        }
