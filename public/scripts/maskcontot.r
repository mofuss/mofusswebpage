...
writeGDAL(as(img_masked, Class = "SpatialPixelsDataFrame"), fname = glue("{CurrDir}/public/maps/gif/contot.gif"), drivername = "GIF", type = "Byte", mvFlag = 255, colorTables = list(gray.colors(255)))
