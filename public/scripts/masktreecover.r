...
img_newproj <- raster(glue("{CurrDir}/public/app-assets/assets/raster/ZM/Hansen_GFC2018_treecover2000_m-004proj2.tif"),ext=e)
e <- extent(bbox(crop_extent))
#print(e)
...
writeGDAL(as(img_masked, Class = "SpatialPixelsDataFrame"), fname = glue("{CurrDir}/public/maps/gif/treecover.gif"), drivername = "GIF", type = "Byte", mvFlag = 255, colorTables = list(gray.colors(255)))
